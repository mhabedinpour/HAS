...
let config = new HAS.Config('NodeJS Bridge', '79:E6:B6:63:BC:2C', HAS.categories.bridge, __dirname + '/bridge.json', 8090, '200-20-200');

let server = new HAS.Server(config);

let identity = new HAS.Characteristic(1, '14', 'bool', false, false, false, false);
identity.onWrite = (value, callback) => {
...
identity2.onWrite = (value, callback) => {
